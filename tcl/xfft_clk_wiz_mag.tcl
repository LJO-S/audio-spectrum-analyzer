...
################################################################
# This is a generated script based on design: xfft_clk_wiz
#
...
# source xfft_clk_wiz_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set o_locked [ create_bd_port -dir O o_locked ]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports o_locked] [get_bd_pins clk_wiz_0/locked]
