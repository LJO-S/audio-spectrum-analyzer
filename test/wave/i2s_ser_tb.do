...
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/i_en
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/o_data
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/o_valid
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/s_deser_state
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/r_lrclk
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/r_bclk
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/w_left
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/w_right
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/w_bclk_re
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/r_bit_cntr
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/r_ldata
add wave -noupdate -group i2s_deser /i2s_ser_tb/i2s_deser_inst/r_rdata
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {46220000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {193167459 ps}
